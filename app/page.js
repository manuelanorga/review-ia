    ...
    <div suppressHydrationWarning style={{ background: BG, minHeight: "100vh", color: TEXT, fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <div style={{ position: "fixed", bottom: 0, left: 0, right: 0, zIndex: 199, background: "#0f0f00", borderTop: "1px solid #2a2800", height: 44, display: "flex", alignItems: "center", overflow: "hidden" }}>
        ...
        <div style={{ flex: 1, overflow: "hidden", position: "relative" }}>
          <div style={{ position: "absolute", left: 0, top: 0, bottom: 0, width: 30, background: "linear-gradient(to right, #0f0f00, transparent)", zIndex: 2 }} />
        ...
        {/* WhatsApp */}
        <a href="https://wa.me/51931067775?text=Hola%2C%20me%20interesa%20RevGo%20para%20mi%20negocio" target="_blank" rel="noopener noreferrer" style={{ display: "flex", alignItems: "center", gap: 8, padding: "0 16px", borderLeft: "1px solid #2a2800", flexShrink: 0, height: "100%", textDecoration: "none", transition: "background 0.2s" }} onMouseOver={e => e.currentTarget.style.background = "rgba(37,211,102,0.08)"} onMouseOut={e => e.currentTarget.style.background = "transparent"}>
