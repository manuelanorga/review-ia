  ...
  return (
    <div style={{ background: "#ffffff", border: "1px solid #e0e0e0", borderRadius: 16, overflow: "hidden", maxWidth: 420, width: "100%", boxShadow: "0 2px 12px rgba(0,0,0,0.08)", minHeight: 420 }}>
      ...
      <div style={{ padding: "14px 16px" }}>
        ...
        {showPublish && (
          <div style={{ marginTop: 10, padding: "10px", background: showPublish ? "#1a73e8" : "#dadce0", borderRadius: 8, fontSize: 13, fontWeight: 700, color: "#fff", textAlign: "center", transition: "background 0.4s ease", cursor: showPublish ? "pointer" : "default" }}>
            Publicar en Google →
          </div>
        )}
    ...
    <div style={{ background: BG, minHeight: "100vh", color: TEXT, fontFamily: "'DM Sans', sans-serif" }}>
      <style suppressHydrationWarning>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .btn-dashboard { background: linear-gradient(135deg, #ec4899, #a855f7, #6366f1, #a855f7, #ec4899) !important; background-size: 300% 300% !important; animation: gradientShift 3s ease infinite !important; transition: transform 0.2s, box-shadow 0.2s !important; border-radius: 50px !important; color: #fff !important; }
        .btn-dashboard:hover { transform: scale(1.04) !important; box-shadow: 0 4px 24px rgba(168,85,247,0.5) !important; }
